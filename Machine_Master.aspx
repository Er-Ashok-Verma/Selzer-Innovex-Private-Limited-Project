<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Machine_Master.aspx.cs" Inherits="Machine_Master" %>
    ...
    <form id="form1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid mt-4">
                    <div class="page-card">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <asp:Label ID="Label1" runat="server" Text="Machine Code"></asp:Label>
                                <asp:TextBox ID="txtMachineCode" runat="server" CssClass="form-control" ></asp:TextBox>
                            </div>
                             <div class="col-md-4">
     ...
     <script type="text/javascript">
         function pageLoad(sender, args) {
             ...
             if ($.fn.DataTable.isDataTable('#grdSFGMapping')) {
