<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Generate_Log.aspx.cs" Inherits="Generate_Log" %>
            ...
            <ContentTemplate>
                <div class="container">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="page-title">Generate Log</span>
                    </div>
                    <div class="heading-line"></div>
                    <label class="form-label fw-semibold">Activity Date:</label>
                    <asp:TextBox ID="txtad" runat="server" CssClass="form-control" Style="width: 50%" placeholder="dd-mm-yyyy" AccessKey="D"
                        onblur="checkdate1(this,'en-US','dd-MMM-yyyy');"></asp:TextBox>

                    <div class="mt-5" style="text-align: center">
                        <asp:Button ID="btnView" runat="server" Text="View" CssClass="asp-btn View-btn" OnClick="btnView_Click" />
                        <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="asp-btn reset-btn" OnClick="btnReset_Click" />
                    </div>
                        ...
                        <asp:GridView ID="gridview" runat="server"
                           ...
                           AlternatingRowStyle-CssClass="grid-alt-row"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Performed Action" DataField="Action" />
